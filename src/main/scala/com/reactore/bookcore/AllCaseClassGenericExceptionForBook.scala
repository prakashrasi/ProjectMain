...
case class EmployeeAvailabilityOverlappingException(errorCode: String = "1012", message: String = "EMPLOYEE_AVAILABILITY_OVERLAPPING_EXCEPTION", exception: Throwable) extends Exception
